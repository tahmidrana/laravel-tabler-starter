            ...
            <div class="navbar-nav flex-row order-md-last">
                ...
                <div class="nav-item dropdown">
                    ...
                    <a href="{{ route('login') }}" class="nav-link d-flex lh-1 text-reset p-0"
                        aria-label="Open user menu">Login</a>
                    @endauth
                            ...
                            @if($menu->child_menus_count > 0)
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle"
                                        ...
                                        >
                                        <i class="ti ti-{{ $menu->menu_icon ?? 'home' }} nav-link-icon d-md-none d-lg-inline-block" style="font-size: 19px;"></i>
                                        <span class="nav-link-title">{{ $menu->title }}</span>
                                    </a>
                                    <div class="dropdown-menu">
                                        @foreach($menu->childMenus as $child_menu)
                                        <a class="dropdown-item"
                                            href="{{ $child_menu->route_name && Route::has($child_menu->route_name) ? route($child_menu->route_name) : '#' }}"
                                            rel="noopener">
                                            {{ $child_menu->title }}
                                        </a>
                                        @endforeach
